...
const CashHistoryDialog = ({
  ...
  const { data, isLoading } = useFetchData({
    method: "GET",
    path: `factory/cash/summary/${factory?.id}`,
  ...
  return (
    <DialogWrapper
      ...
      triggerContent={
        <Card
          className="relative w-full border-2 border-dashed transition-all duration-200 cursor-pointer hover:shadow-md border-slate-200 dark:border-slate-700 dark:hover:border-slate-600 hover:border-slate-300"
...
export default CashHistoryDialog;
